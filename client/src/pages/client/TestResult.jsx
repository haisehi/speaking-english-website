...
export default function TestResult() {
    ...
    const totalQuestions = Number(searchParams.get('total') || 1)

    const normalizedScore = rawScore / 10                    
    const percentage = Math.round((normalizedScore / totalQuestions) * 100)

    const correctAnswers = Math.round(normalizedScore)
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="max-w-2xl mx-auto px-6 py-16 text-center">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
                    <div className="text-7xl font-bold mb-3 text-blue-500">
                        {percentage}%
                    </div>
