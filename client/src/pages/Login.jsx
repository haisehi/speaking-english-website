        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white py-3.5 rounded-xl font-semibold hover:shadow-lg transition-shadow disabled:opacity-60"
            >
            ...
            <p className="text-center text-gray-600">
              ...
              <Link href="/register">
                <a className="text-blue-500 hover:text-blue-600 font-semibold">
                  Sign Up
                </a>
              </Link>
            </p>
